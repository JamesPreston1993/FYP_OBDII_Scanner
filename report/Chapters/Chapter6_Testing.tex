...
\section{Usability Testing}{
	...
	\paragraph{}{
	Once all participants had completed the survey, the results were analysed.
	%[RESULTS]
	}
	
	\paragraph{}{
	The analysis of the results highlighted a few usability issues and areas for future work. For example,
	%[REFLECTIONS]
	}		
	\label{sec:Usability}
}
...
\section{Software Quality}{
	...
	\paragraph{}{
	The main tool used to capture the code metrics was Visual Studio. The metrics that are available are lines of code, maintainability index, class coupling, cyclomatic complexity and depth of inheritance. The metrics were run on each project: the core library, the UWP application and the android application. The results for each can be found in Tables \ref{tab:CoreLib}, \ref{tab:UWPApp} and \ref{tab:AndroidApp} respectively.
