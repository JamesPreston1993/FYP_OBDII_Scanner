	...
	\begin{table}[ht]		
			\begin{center}				
				...
				\multirow{2}{*}{Bluetooth Communication} & Semester 1, Week 1 - Semester 1, Week 4\\
														 & Holiday 1, Week 1 - Holiday 1, Week 3\\
				\hline
				DTC Module & Semester 1, Week 5 - Semester 1, Week 9\\
				\hline
				\multirow{2}{*}{Data Module} & Holiday 1, Week 1 - Holiday 1, Week 3\\
											 & Semester 2, Week 1 - Semester 2, Week 2\\
				\hline				
				Simulated Communication & Holiday 1, Week 1 - Holiday 1, Week 3\\
				\hline
				\multirow{2}{*}{Connection Module} & Holiday 1, Week 3\\
				  								   & Semester 2, Week 4 - Semester 2, Week 4\\
				\hline
				\multirow{2}{*}{Android Port} & Holiday 1, Week 2 - Holiday 1, Week 3\\ %4
...
\section{Summary of Implementation}
	\paragraph{}{
	At the end of the implementation phase, the system consisted of three projects with a total of around 1694 lines of executable code and seventy five classes and interfaces. A more detailed description and statistics relating to these projects is available in section \ref{sec:Quality}. These three projects are:
	 	\begin{enumerate}
	...
	\paragraph{}{
	Overall, the implementation phase was a success. The features outlined in this chapter were implemented to a high standard with minimal drift from the project timeline.  Although a number of issues were encountered, a solution was found with minimal disruption to the existing product.
	% Summary
	}