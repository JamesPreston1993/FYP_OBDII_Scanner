...
\section{Technology}
	\subsection{ELM327}
		\paragraph{}{
		The ELM327 device used for this project is a compact Bluetooth dongle that can connect to the OBDII port on modern vehicles. The device is relatively inexpensive, with the model used in this project (see figure \ref{ELM327}) costing {\textsterling}12.95. It supports all OBDII protocols and abstracts the data transfer process by including its own set of commands to handle communication.				
		}
		\paragraph{}{
		...
		\begin{figure}[h]
				\begin{center}											
					...
					\caption{ELM327 Bluetooth Dongle}														\label{ELM327}
				\end{center}
		\end{figure}		
\newpage
